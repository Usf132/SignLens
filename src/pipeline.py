from src.yolo_detector import YOLOHandDetector
from src.landmark import extract_landmarks, extract_features
from src.recognizer import SignRecognizer
from src.stabilizer import PredictionStabilizer
from src.sentence import SentenceBuilder
...
class SignPipeline:
    ...
    def __init__(
        self,
        yolo_model_path="models/yolo_best_weights.pt",
